...
public class TagTextView extends TextView {
    ...
    public TagTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.TagTextView, 0, 0);
        try {
            tagType = typedArray.getInteger(R.styleable.TagTextView_tagType, CLASSIC);
            tagColor = typedArray.getColor(R.styleable.TagTextView_tagColor, Color.BLACK);
            tagUpperCase = typedArray.getBoolean(R.styleable.TagTextView_tagUpperCase, false);
            tagBorderRadius = typedArray.getInteger(R.styleable.TagTextView_tagBorderRadius, BORDER_RADIUS_DEFAULT);
            tagCircleRadius = typedArray.getInteger(R.styleable.TagTextView_tagCircleRadius, CIRCLE_RADIUS_DEFAULT);
            tagCircleColor = typedArray.getColor(R.styleable.TagTextView_tagCircleColor, CIRCLE_COLOR_DEFAULT);
            tagTextColor = typedArray.getColor(R.styleable.TagTextView_tagTextColor, TEXT_COLOR_DEFAULT);
        } finally {
            typedArray.recycle();
        }
    ...
    private Path getReversedTrianglePath(RectF rect, float halfOfRectHeight) {
        ...
        path.lineTo((float)(rect.left - tagLeftPadding * 1.5), halfOfRectHeight);
